...
export async function sendJobNotificationEmail({
  ...
  const scoreColor = fitScore >= 9 ? '#16a34a' : fitScore >= 7 ? '#d97706' : '#dc2626';
        ...
        <div style="max-width: 600px; margin: 0 auto; padding: 24px;">
          ...
          <div style="background: white; padding: 24px; border: 1px solid #e5e7eb; border-top: none;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 6px 0; color: #6b7280; font-size: 14px; width: 40%;">📍 Location</td>
                <td style="padding: 6px 0; color: #111827; font-size: 14px; font-weight: 500;">${location}</td>
              </tr>
              <tr>
                <td style="padding: 6px 0; color: #6b7280; font-size: 14px;">💼 Work Type</td>
                <td style="padding: 6px 0; color: #111827; font-size: 14px; font-weight: 500;">${workType}</td>
              </tr>
              <tr>
                <td style="padding: 6px 0; color: #6b7280; font-size: 14px;">💰 Salary</td>
                <td style="padding: 6px 0; color: #111827; font-size: 14px; font-weight: 500;">${salary}</td>
              </tr>
              <tr>
                <td style="padding: 6px 0; color: #6b7280; font-size: 14px;">🌐 Platform</td>
                <td style="padding: 6px 0; color: #111827; font-size: 14px; font-weight: 500;">${platform}</td>
              </tr>
            </table>
          </div>
          ...
          <div style="background: white; padding: 24px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px; text-align: center;">
            ...
            <a href="${jobUrl}" style="background: #4F46E5; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-size: 16px; font-weight: 600; display: inline-block;">
              Apply Now →
            </a>
            <p style="color: #9ca3af; font-size: 12px; margin: 20px 0 0;">
              You're receiving this because you set up job alerts on JobApply AI.
            </p>
          </div>
